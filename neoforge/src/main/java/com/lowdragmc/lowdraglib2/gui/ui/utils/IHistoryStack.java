...
public interface IHistoryStack {
    ...
    default <T extends ValueIOSerializable> SerializableRecordAction<T> recordSerializableObject(Component name, T object) {
        return recordSerializableObject(name, object, null);
    }

    default <T extends ValueIOSerializable> SerializableRecordAction<T> recordSerializableObject(Component name, T object, @Nullable Object source) {
